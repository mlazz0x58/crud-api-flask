...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:your_password_here@localhost/db_cadastro'
...
def cria_usuario():
    ...
    # Ou utilizar um try except para  gerar erro
...
def atualiza_usuario(id):
    # pegar usuário e as modificações
    usuario_objeto = Usuario.query.filter_by(id=id).first()
    body = request.get_json()
